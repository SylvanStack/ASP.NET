...
namespace EFProject
{
    public partial class StudentUpData : Form
    {
        ...
        public StudentUpData(string str)
        {
            InitializeComponent();
            Str = str;
            Istuid = -1;
            ...
            else
            {
                if (YZ())
                {
                    if (SelectID != null)
                    {
                        ...
                        sin.Sex = comboBox2.SelectedItem.ToString();
                        sin.Remark = txtPj.Text;
                        sin.DelFlag = comboBox1.SelectedItem.ToString() == "是";
                        sin.LastTime = DateTime.Now.ToString();
                    ...
                    else
                    {
                        ...
                        stu.DelFlag = comboBox1.SelectedItem.ToString() == "是";
