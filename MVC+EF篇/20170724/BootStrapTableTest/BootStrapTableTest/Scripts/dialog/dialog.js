	...
	f.pt.vessel = function (a, b) {
		...
		function () {
			...
			if (e.type[f.type] == "iframe") {
				Content_IsClose = '<div style="float: left;padding-top:5px;padding-left:15px;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;user-select: none;" class="labelBox"><label style="cursor:pointer;font-weigth:normal;"><input checked="checked" type="checkbox" id="IsdialogClose" style="vertical-align:middle;margin-bottom:2px;margin-right:5px;" />确认并关闭窗口</label></div>';
			}
