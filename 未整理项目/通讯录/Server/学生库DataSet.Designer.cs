...
namespace Server.学生库DataSetTableAdapters {
...
SELECT 用户名, 密码, 联系人数量最大值, 组别数量最大值 FROM 用户 WHERE (用户名 = @用户名)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Server.Properties.Settings.Default.学生库ConnectionString;
        }
        ...
        public virtual int Fill(学生库DataSet.用户DataTable dataTable) {
        ...
        public virtual 学生库DataSet.用户DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            学生库DataSet.用户DataTable dataTable = new 学生库DataSet.用户DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(学生库DataSet.用户DataTable dataTable) {
